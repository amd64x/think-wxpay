    ...
    public function GetOpenid()
    {
        ...
        if (!isset($_GET['code'])){
            ...
            if ($openid) {
                ...
                $pu = parse_url($url);
                $url = $pu["scheme"] . "://";
                if (isset($pu["user"]) && isset($pu["pass"]) ) {
                    $url .= $pu["user"] . ":" . $pu["pass"] . "@";
                } elseif (isset($pu["user"])) {
                    $url .= $pu["user"] . "@";
                }
                if (isset($pu["host"]) && $pu["host"])
                    $url .= $pu["host"];
                if (isset($pu["port"]) && $pu["port"])
                    $url .= ":" . $pu["port"];
                if (isset($pu["path"]) && $pu["path"])
                    $url .= $pu["path"];
                if (isset($pu["query"]) && $pu["query"]) {
                    parse_str($pu["query"], $ps);
                    unset($ps["code"]);
                    $url .= "?" . http_build_query($ps);
                }
                if (isset($pu["fragment"]) && $pu["fragment"])
                    $url .= "#" . $pu["fragment"];
